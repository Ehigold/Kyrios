<section class="fixed print:hidden top-0 left-0 right-0 z-50 w-full bg-white">
    <div class="w-full flex flex-wrap items-center justify-between p-2 mx-auto ">
        ...
        <div class="flex items-center ">
            <button id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar"
                ...
                <svg id="toggleSidebarMobileClose" class="hidden w-6 h-6" fill="#bb2127" viewBox="0 0 20 20"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
        ...
        <form action="" method="GET" class="relative w-full max-w-md">
            ...
            <button type="submit" class="absolute inset-y-0 left-0 flex items-center pl-3">
                <svg class="w-5 h-5 text-gray-500" fill="none" stroke="#bb2127" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="flex items-center ml-auto">
            ...
            <div class="z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700 notification-tab"
            ...
            <div class="flex items-center ml-3">
                ...
                <div class="ml-5 text-black dark:text-gray-200"> {{ Auth::user()->first_name }} </div>
                ...
                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                    ...
                    <ul class="py-1" role="none">
                        <li>
                            <a href=""
                                class="block px-4 py-2 text-gray-700 text-md hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
