...
<footer class="p-4 mx-4 my-6 border-gray-700 rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8 print:hidden">
...
&copy; {{ date('Y') }} <a href="" class="hover:underline" target="_blank"> </a>. All rights reserved.
</p>
